 	...
 	<div class="row">
		...
		<div class="col">	  
			...
			<div class="row mt-5">
				...
				<div class="col"><a href="../shop/ordersInfoPage"><i class="bi bi-file-earmark-text" style="font-size: 5em;"></i></a></div>
			</div>	
			<hr>  
			...
			<div class="row mt-3">
				...
				<div class="col"><a href="../member/memberInfo"><i class="bi bi-person-fill" style="font-size: 5em;"></i></a></div>
			</div>	
			<hr>  
