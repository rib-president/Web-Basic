 	...
 	<div class="row">
		...
		<div class="col shop-start-col">	  
		  ...
		  <div class="row mt-5">
		  	<div class="col">
		  		<div class="row">
		  			<c:forEach items="${brandCategoryCountList }" var="brandCategoryCount">
		  			  <div class="col">
		  			    <a href="../shop/categoryViewPage?product_category_no=${product_CategoryVo.product_category_no }&brand_no=${brandCategoryCount.BRAND_NO}">${brandCategoryCount.BRAND_NAME }(${brandCategoryCount.PRODUCT_COUNT })</a>
		  			  </div>
		  			</c:forEach>
		  			<div class="col"></div>
		  			<div class="col"></div>
		  ...
		  <hr>
		  <div class="row">
		  	<div class="col mb-5">total ${fn:length(voList) } items</div>
		  </div>	  
