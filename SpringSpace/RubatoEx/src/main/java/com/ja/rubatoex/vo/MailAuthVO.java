...
public class MailAuthVO {
	...
	public MailAuthVO(int mailauth_no, int member_no, String mailauth_key, String mailauth_complete, Date mailauth_exp,
			Date mailauth_date) {
		super();
		...
		this.mailauth_exp = mailauth_exp;
	...
	public Date getMailauth_exp() {
		return mailauth_exp;
	}

	public void setMailauth_exp(Date mailauth_exp) {
		this.mailauth_exp = mailauth_exp;
	}
